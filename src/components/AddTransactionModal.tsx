    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 bg-slate-900/60 backdrop-blur-xs overflow-y-auto">
      <div className="bg-white rounded-3xl w-full max-w-lg shadow-2xl border border-slate-100 overflow-hidden my-auto max-h-[96vh] flex flex-col">
        ...
        <div className="p-5 overflow-y-auto space-y-4">
          ...
          {/* Payment Method Dropdown Section (নগদ, বিকাশ, ব্যাংক) */}
          <div className="bg-slate-50 p-3.5 rounded-2xl border border-slate-200 space-y-2 text-left">
            <div className="flex items-center justify-between">
              <label htmlFor="payment-method-select" className="text-xs font-bold text-slate-700 flex items-center gap-1.5 uppercase tracking-wider">
              ...
              <span className="text-[11px] font-semibold text-emerald-700 bg-emerald-100/70 px-2 py-0.5 rounded-md">
                {paymentMethod === 'cash' ? '💵 নগদ ক্যাশ' : paymentMethod === 'bkash' ? '📱 বিকাশ' : paymentMethod === 'bank' ? '🏦 ব্যাংক' : paymentMethod === 'nagad' ? '📲 নগদ ওয়ালেট' : '📝 অন্যান্য'}
              </span>
            </div>
            ...
            <div className="relative">
              <select
                ...
                className="w-full bg-white border-2 border-slate-200 hover:border-emerald-500 focus:border-emerald-600 rounded-xl px-3.5 py-2.5 text-sm font-bold text-slate-800 focus:outline-none focus:ring-2 focus:ring-emerald-500/20 shadow-2xs transition cursor-pointer appearance-none"
              >
                <option value="cash">💵 নগদ (Cash)</option>
                <option value="bkash">📱 বিকাশ (bKash)</option>
                <option value="bank">🏦 ব্যাংক (Bank Transfer / Cheque)</option>
